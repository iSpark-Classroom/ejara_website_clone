  ...
  return (
    <div className="container">
      <div className="capital">
        ...
        <p>
          Your investment is secured by the BEAC,offering maximum protection of
          your capital with minimal risk.
        </p>
    ...
    <div>
      ...
      <p>
        Start investing from 1000 FCFA and build 
        your investment portfolio at your pace, with 
        no hidden fees.
      </p>
    </div>
